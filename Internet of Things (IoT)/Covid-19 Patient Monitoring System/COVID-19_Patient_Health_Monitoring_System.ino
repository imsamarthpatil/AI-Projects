 ...
 * 19BAI10079
 * CSE3001 Database Management Systems B11 slot
...
const char* ssid = "Kalpataru";  // Enter SSID here
const char* password = "samarth@1234";  //Enter Password here
...
void handle_NotFound(){
  ...
  ptr +="<html>";
  ptr +="<head>";
  ptr +="<title>Quarantined Patient Health Monitoring</title>";
  ...
  ptr +="</head>";
  ptr +="<body>";
  ptr +="<h1>Quarantined Patient Health Monitoring System</h1>";
  ptr +="<h3>Patient X</h3>";
